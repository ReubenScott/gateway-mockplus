...
public class GetMatchedSysCfgResponseHandler extends ResponseHandler {
    public GetMatchedSysCfgResponseHandler(SessionManager sm, Date date, String xml) {
        super(sm, date, xml);
    }
    ...
    public void run() {
        try {
            if (!response.getType().equals("bad")) {
                ...
                System.out.println("Get matched system configuration failed!");
